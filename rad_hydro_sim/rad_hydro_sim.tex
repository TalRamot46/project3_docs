...
\begin{enumerate}
  ...
  \begin{equation}
    ...
    \end{aligned}
  \end{equation}
  \textcolor{blue}{NOTE that in our case $\Delta m_{i+\frac{1}{2}}$ is constant for all $i$ and therefore $\Delta m_i = const$ and is a \textbf{predefined parameter} of the simulation.}
...
\begin{enumerate}
  ...
  \end{equation}
  and in our case (after the hydro step, and using the implicit scheme):
  \begin{equation}
    F_{i}^{n+1} = -\rho_{i+\frac{1}{2}}^* D_{i}^n \frac{E_{i+\frac{1}{2}}^{n+1} - E_{i-\frac{1}{2}}^{n+1}}{m_{i+\frac{1}{2}}} = -\rho_{i+\frac{1}{2}}^* \frac{2D_{i-\frac{1}{2}}^{n} D_{i+\frac{1}{2}}^{n}}{D_{i - \frac{1}{2}}^{n} + D_{i+\frac{1}{2}}^{n}}\frac{E_{i+\frac{1}{2}}^{n+1} - E_{i-\frac{1}{2}}^{n+1}}{m_{i+\frac{1}{2}}}
  \end{equation}
