...
\begin{enumerate}
  ...
  \begin{equation}
    F_{i}^{n} = -\rho_{i+\frac{1}{2}}^{n} D_{i}^n \frac{E_{i+\frac{1}{2}}^{n} - E_{i-\frac{1}{2}}^{n}}{\Delta m_i}
  \end{equation}
  Where I used here the notation of:
  \begin{equation}
  ...
  It also be denoted $\Delta m_i = m_{i+\frac{1}{2}} - m_{i-\frac{1}{2}}$ where $m_{i+\frac{1}{2}} = m_{i} + \frac{1}{2} \Delta m_{i+\frac{1}{2}}$.
  \begin{equation}
    \Delta m_i = m_i + \frac{1}{2} \Delta m_{i+\frac{1}{2}} - \left(m_{i-1} + \frac{1}{2} \Delta m_{i-\frac{1}{2}}\right) 
  \end{equation}
  NOTE that in our case $\Delta m_{i+\frac{1}{2}}$ is constant for all $i$ and therefore $\Delta m_i = const$ and is a \textbf{predefined parameter} of the simulation.
  \item The diffusion constant (which is also defined at the nodes) is an harmonic mean of the diffusion constants at the surrounding cell centers:
  \begin{equation}
