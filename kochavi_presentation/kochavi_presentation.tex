...
\subtitle{Understanding the physics of x-ray radiation driven supersonic heat waves}
...
\begin{frame}{Cylinder Coordinates}
    \begin{columns}
        \begin{column}{0.58\textwidth}
            The model was re-developed in cylindrical coordinates (\textit{Courtois at el. POP, (2022)}) to match cylindrical geometries:
            \begin{equation*}
